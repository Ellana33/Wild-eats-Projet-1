...
function createRestaurants (title, imageUrl, type, reward, price, filter) {
    const restaurant = document.createElement("div");
    restaurant.classList.add("restaurant-card");
    restaurant.setAttribute("data-filter",filter);
...
for (let index = 0; index < listOfRestaurants.length; index++) {
    ...
    createRestaurants(restaurant.name, restaurant.picture, restaurant.type, restaurant.note, restaurant.price, restaurant.filter);
}