const listOfRestaurants = [
    {
        ...
        feedback: ["Fontanille Nina :", "Un des meilleurs restaurant italien à Bordeaux. Habitant à 45 min de votre restaurant, nous sommes à chaque fois impatient de venir y déguster vos plats ...",
    ...
    },
    {
        ...
        feedback: ["Véronique Frémond-Kahlouche :", "Très agréable restaurant où l'accueil est particulièrement chalereux ! On y mange de très bonnes choses de grande qualité et fraîcheur ! J'adore y aller ! Je recommande chaudement.",
    ...
    },
    {
        ...
        feedback: ["Franck :", "Une excellente découverte. Un acceuil professionnel et souriant. Une équipe dynamique, agréable et complice. Le tartare de boeuf était parfait ...",
        "EmmaVoiture :", "Serveurs au top, acceuillants, souriants, serviables, rien à redire ! Très bonne salade César. Dommage pour les profiteroles qui ne sont plus à la carte, nous avions eu la chance de les goûter la fois dernière.",
        "ThomasVoiture :", "Belle et grande salle bien décorée avec une grande terrasse au bord du Bassin à Flots. Le cadre est top! L'acceuil est chaleureux direct en passant la porte. L'équipe est très serviable et polis."],
    },
    {
        name: "Su and Shi",
    ...
    },
    {
        ...
        "QuentinHommevient :", "Portier misérable. Très désagréable et impolie. Impossible de distinguer si il s'agit d'un client ou un membre du personnel, surtout quand ce dernier discute avec une femme au lieu d'acceuillir ses clients."],
    },
    {
    ...
    },
    {
        ...
        feedback: ["QuentinToint :", "Excellent restaurant, de la réservation au dessert ! Personnel très sympathique, très belle mise en avant des capacités du personnel, l'histoire qui se cache derrière ce restaurant est belle et donne envie de voir ce genre de restaurant plus souvent. Cuisine délicieuse mais un peu cher tout de même. Nous n'avons pas pu profiter de la terrasse à l'étage étant fermée,  nous avons cependant passé un agréable moment ! Je recommande !",
        "Celine :", "Très bon accueil, en salle tous les serveurs sont extrêmement bienveillants souriants et agréables. Les plats étaient très très bons, bien présentés et copieux. Nous avons passé un bon momment dans ce restaurant. Merci ! (Et merci aussi pour la bougie sur le dessert).",
        "AnneUel :", "Nous avons réservé au dernier moment pour 8 personnes et avons été reçu avec bienveillance. La cuisine est délicieuse et le service est impeccable et attentionné. Un grand merci à tout le personnel pour ce très bon moment passé dans votre restaurant !"],
    },
    {
        name: "Café Maritime",
        ...
        feedback: ["Celine :", "Je recommande vivement, un endroit chaleureux, une superbe déco et de très bons plats. Le brunch est fabuleux.",
        "F C :", "Nous avons passé un très bon moment au Café Maritime. Nous sommes arrivés en fin de service et nous avons été très bien accueillis. Nous avons très bien mangé. C'est un lieu que nous apprécions !!",
        "VincentTire :", "Très bel endroit pour déjeuner. Le menu avec entrée plat dessert à 22 €. Même pour un menu, les repas sont de qualité. Il ne faut pas hésiter"],
    }
];
